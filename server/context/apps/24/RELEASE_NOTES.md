# App 24 Release Notes


## 2026-03-15T14:26:43.999Z publish failed
- phase: db_check
- type: SCHEMA_DRYRUN_FAILED
- retryable: yes
- detail: release dry-run blocked before deploy: - SQL "SELECT s.id AS session_id, s.user_id, u.name, u.gender, u.age, u.created_at AS user_created_at " +
    "FROM sessions s " +
